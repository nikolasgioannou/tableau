...
describe("getToolLabel", () => {
  it("labels updateSlide correctly", () => {
    expect(getToolLabel("updateSlide", { slideIndex: 2 })).toBe("Updated slide 3");
  });

  it("labels bulkUpdateSlides correctly", () => {
    expect(
      getToolLabel("bulkUpdateSlides", { updates: [{}, {}, {}] }),
    ).toBe("Bulk updated 3 slides");
  });
  ...
  it("labels deleteSlide correctly", () => {
    expect(getToolLabel("deleteSlide", { slideIndex: 0 })).toBe("Deleted slide 1");
  });
