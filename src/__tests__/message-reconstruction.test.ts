        ...
        toolCalls: [
          {
            ...
            toolName: "addSlide",
            input: '{"body":"<div>Hello</div>","description":"Title slide"}',
        ...
        toolCalls: [
          {
            ...
            toolCallId: "tc_step0",
            toolName: "addSlide",
            input: '{"body":"<div>1</div>","description":"slide 1"}',
            output: '{"success":true}',
          },
        ],
      },
        ...
        toolCalls: [
          {
            ...
            toolCallId: "tc_step1",
            toolName: "addSlide",
            input: '{"body":"<div>2</div>","description":"slide 2"}',
            output: '{"success":true}',
          },
        ],
      },
        ...
        toolCalls: [
          {
            ...
            input:
              '{"slideIndex":0,"body":"<div>A</div>","reasoning":"update"}',
            output: '{"success":true}',
          },
          {
            id: "db-2",
            ...
            toolName: "updateSlide",
            input:
              '{"slideIndex":1,"body":"<div>B</div>","reasoning":"update"}',
            output: '{"success":true}',
          },
        ],
      },
        ...
        toolCalls: [
          {
            ...
            toolCallId: "tc_1",
            toolName: "addSlide",
            input: '{"body":"<div/>","description":"test"}',
            output: '{"success":true}',
          },
        ],
      },
